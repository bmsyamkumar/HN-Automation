...
public class SendEmail {
	...
	/*public static void main(String [] args) throws Exception{
		SendEmail gm = new SendEmail();
		 String[] strArray = new String[]{"syamkumar.bm@cigniti.com","venugopal.kadiri@cigniti.com"};
		gm.sendEmailReport("", "587", "shyamtst123@gmail.com", "testpwd12",strArray , "HI", "HEllo", "");
