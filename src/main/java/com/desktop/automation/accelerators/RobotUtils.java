...
/*
	...
	public static void main(String[] args) throws AWTException, InterruptedException {
		...
		//switchToFrameByLocator(AddMeProfilePageLocators.main_frame, "Add ME Profile page");
		Thread.sleep(2000);
		RobotUtils.initRobot();
		Thread.sleep(2000);
		//waitForElementPresent(By.xpath("//a[contains(text(),'Add ME Profile')]"), "ME Profile Creation Successful Message");
